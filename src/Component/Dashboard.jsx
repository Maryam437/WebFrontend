...
function Dashboard() {
  ...
  <nav className="bg-gray-800">
      ...
      <div className="flex h-16 items-center justify-between">
        <div className="flex items-center">
          <div className="flex-shrink-0">
            <img className="h-9 w-9 round-full" src= {Logo} alt=" my profile"/>
          </div>
          <div className="hidden md:block">
            <div className="ml-10 flex items-baseline space-x-4">
              ...
              <Link to="Instructure" className="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Instucture</Link>
              <Link to="CourseForm" className="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">CourseForm</Link>
            </div>
          </div>
        </div>
        <div className="hidden md:block">
    ...
    <div className="md:hidden" id="mobile-menu">
      <div className="space-y-1 px-2 pb-3 pt-2 sm:px-3">
        ...
        <a href="#" className="text-gray-300 hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium">Course</a>
      ...
      <div className="border-t border-gray-700 pb-3 pt-4">
        <div className="flex items-center px-5">
          <div className="flex-shrink-0">
            <img className="h-10 w-10 rounded-full" src={online} alt=""/>
          </div>
          <div className="ml-3">
  ...
  <body>
    <p> Dear student you are welcome in our system please use the option below of the pone respectivelly and get your tasks done here!
                           Thanks!!!
    </p> 
    </body>
</div>
